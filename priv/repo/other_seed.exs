defmodule BuzzKillfeed.Seed do
  use Ecto.Repo

  def seed_nouns do
                 "Republican", "Democrat",
                "Frood", "Reptile", "Guy", "Little Boy", "Micropig", "Duck",
                ...
                "Micropig", "Old Cat", "Little Boy", "Guy","Reptile", "Nerd","Geek","Cosplayer","Otaku"])
  end
end
#def seed_seasonal_nouns do
...
#def seed_proper_nouns do                                                                                                                                                                                                                                                                                                                                                                          ["Wil Wheaton","Obama", "The FBI", "Bill Maher", "Bill O"Reilly", "Ann Coulter", "Rush Limbaugh", "Glenn Beck",
# ["Vladimir Putin", "The CIA", "Julian Assange","Edward Snowden","Linus Torvalds",
# "Ada Lovelace","Brian Kernighan","Dennis Ritchie",
# "Grace Hopper","Steve Jobs","Steve Ballmer",
#  "Paul Allen","Alan Turing","Martin Shkreli","Bae", "Jeff Bezos"]
#end
#
#def seed_seasonal_agents do
#  %{
...
#end
#
#def seed_sesonal_proper_nouns do
#  %{
...
#
#
#def seed_["Low-Carb Lunch", "Book", "Photo", "Movie", "Rumor", "Conspiracy Theory", "Sign", "Country", "City",
...
# "Brain Hack","Life Hack","Pug Moment","Squad Goal","Your Face", "Kiss","Sex Toy"]
#end
#
